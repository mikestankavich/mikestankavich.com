...
### <u>Staff Software Engineer and Technical Leader with 20+ years of experience</u>
...
- Extensive SQL database experience with a focus on PostgreSQL and SQL Server
...
- 2022-2023 (contract) - Senior Cloud Infrastructure Engineer at Enigma (fintech SaaS):
  Refactored repo-per-service Terraform IaC and Gitlab CI/CD to monorepo to support transition from single tenant to multi-tenant for a go to market effort. Built IaC tooling, optimized performance, and worked production issues for multi-region AWS RDS Postgres instances. Split multi-environment Terraform states into state-per-environment. Optimized developer tooling for local development and docker builds for smaller container size and faster builds.
